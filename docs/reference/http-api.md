...
| Field | Type | Required | Description |
|---|---|---|---|
| `auth` | boolean | yes | Whether a token is required. |
...
| `token_file` | string or null | no | The file holding the generated token when the server generated one. |
