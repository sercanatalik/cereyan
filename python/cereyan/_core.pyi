...
class Store:
    ...
    def get_variable_flagged(self, name: str) -> tuple[str, bool] | None: ...
    ...
    def set_run_attributes(self, run_id: int, patch: str) -> bool: ...
    def backup(self) -> str: ...
    def flush(self) -> None: ...
...
def schedule_fires(spec_json: str, after_micros: int, count: int) -> list[int]: ...
def check_routes(specs_json: str) -> None: ...
